    ...
    <section id="valeurs" ref={sectionRef} className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="sr text-center mb-14">
          ...
          <p className="text-[#4A4A4A]/60 max-w-lg mx-auto">{t("values.subtitle") as string}</p>
        </div>
          ...
          {Array.isArray(items) && items.map((val, i) => {
            ...
            return (
              <motion.div
                ...
                style={{
                  background: i === 0 ? "#FFF6E1" : (i % 2 === 0 ? "#FFF6E1" : "#fff"),
              ...
              >
                ...
                {/* Text */}
                <div>
                  <h3 className="font-black text-[#4A4A4A] text-lg mb-2 group-hover:text-[#026D41] transition-colors">
                    {val.title}
                  </h3>
                  <p className="text-[#4A4A4A]/60 text-sm leading-relaxed">{val.desc}</p>
                </div>
