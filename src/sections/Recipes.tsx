    ...
    <section id="recettes" ref={sectionRef} className="py-20 lg:py-28 overflow-hidden" style={{ background: "#FFF8EC" }}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
              ...
              <>
                ...
                >
                  <motion.div
                    ...
                    style={{ width: 72, height: 72, background: "#F4D233" }}
                  >
                    <svg className="w-8 h-8 ml-1" fill="#1D5D2B" viewBox="0 0 24 24">
          ...
          {/* Card content */}
          <div className="p-5">
            <h3 className="font-black text-[#1a1a1a] text-base leading-tight mb-3 group-hover:text-[#1D5D2B] transition-colors line-clamp-2">
              {VIDEO.title}
            </h3>
